...
<title>库房储备设置-顺达物流</title>
	...
	<body>
		<div class="container-fluid">
			<form>
			<div class="container">
				<h2 class="text-left h2color">库房储备设置</h2>
			...
			<div id="">
				...
				<table class="table">
					...
					<tr>
						...
						<td></td>
						<td>
							<img src="../img/look-icon.png" title="查看" onclick="window.location.href='stockmemory-detail.jsp'"  width="22px" height="22px">
							<img src="../img/edit-icon.gif" title="修改" onclick="window.location.href='stockmemory-detail.jsp-update.jsp'"  width="22px" height="22px">
