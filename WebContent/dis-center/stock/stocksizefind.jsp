...
<title>库存量查询-顺达物流</title>
	...
	<body>
		<div class="container-fluid">
			<form>
			<div class="container">
				<h2 class="text-left h2color">库存量查询</h2>
			...
			<div id="">
					<table class="table table-hover">
						...
						<tr>
							...
							<td>出入库日期</td>
							<td class="form-inline">
								<input type="text" class="form-control inputwidth" id="test1" >到<input type="text" class="form-control inputwidth" id="test2" >
							</td>
						</tr>
					</table>
				</form>
