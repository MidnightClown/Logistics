...
<title>进货安排-顺达物流</title>
	...
	<body>
		<div class="container-fluid">
			<div class="container">
				<h2 class="text-left h2color">进货安排</h2>
			...
			<div id="">
				...
				<table class="table">
					...
					<tr>
						...
						<td><img src="../img/stock-ico.gif" title="进货登记" onclick="window.location.href='getGoods1.jsp'"  width="22px" height="22px"></td>
					</tr>
				</table>
				<div class="Topager">
