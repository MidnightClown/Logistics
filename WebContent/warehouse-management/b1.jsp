...
<title>商品出库</title>
		...
		<script src="DatePlug/layDate-v5.0.9/laydate/laydate.js"></script>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="container">
				<h2 class="text-left h2color">商品出库</h2>
					...
					<table class="table table-hover">
						<tr>
							<td style="text-align: left;line-height: 33px;">
								要求完成的日期:<input id="date" type="text" >
								<script>
									laydate.render({
										elem: '#date',
			...
			<div>				
					<table class="table table-striped">
						...
						<tr>
							...
							<td>...</td>
							<td>
								<a href="#" id="img"><img src="img/Fugue_1031.png"/></a>
								<script>
						...
						<tr>
							...
							<td>
								<a href="#"><img src="img/Fugue_1031.png"/></a>
							</td>
						</tr>
