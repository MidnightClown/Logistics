...
<title>退货-顺达物流</title>
	...
	<body>
		<div class="container-fluid">
			<div class="container">
				<h2 class="text-left h2color">换购物品</h2>
			...
			<div id="">
				<form>
					<table class="table table-hover">
						<tr>
							<td style="background-color: #265A88;color: white;" colspan="4">换购物品</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="4" class="text-center"> <a class="btn btn-default text-right" href="exchangeGoodssetp1.jsp" role="button">上一步</a><a class="btn btn-default text-right" href="../SearchClient.jsp" role="button">换购此商品</a><a class="btn btn-default text-right" href="exchangeGoodsstep3.jsp" role="button">下一步</a></td>
						</tr>
					</table>
				</form>
