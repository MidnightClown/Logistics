...
<title>换货-顺达物流</title>
	...
	<body>
		<div class="container-fluid">
			<div class="container">
				<h2 class="text-left h2color">换货</h2>
			...
			<div id="">
				<form>
					<table class="table table-hover">
						<tr>
							<td style="background-color: #265A88;color: white;" colspan="4">换货</td>
						</tr>
						<tr>
							<td >原订单编号</td>
							<td>GGD1516</td>
						...
						<tr>
							...
							<td colspan="2"><a class="btn btn-default text-right" href="exchangeGoodssetp1.jsp" role="button">换货</a></td>
						</tr>
					</table>
				</form>
