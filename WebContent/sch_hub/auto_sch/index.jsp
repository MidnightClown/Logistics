...
<title>新订订单-顺达物流</title>
	...
	<body>
		<div class="container-fluid container" style="@media (min-width: 1200px).container {width: 100%;}">
			<div class="container">
				<h2 class="text-left h2color">自动调度</h2>
			...
			<div class="container">
               ...
               -->
					<div align="right">
						<input type="button"  class="btn btn-default" value="自动调度" onclick="window.open('../harmonic.jsp');" />
						<input type="button"  class="btn btn-default" value="打印任务单" onclick="window.open('../taskbar.jsp');" />
						<script>
							function toman(){
